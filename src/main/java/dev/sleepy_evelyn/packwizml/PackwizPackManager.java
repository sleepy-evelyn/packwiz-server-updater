...
public final class PackwizPackManager {
    ...
    public void update(String packTomlLink, boolean hasBootstrap, @Nullable CommandContext<CommandSourceStack> ctx) {
    ...
    public static @NotNull URL testPackTomlLink(@NotNull final String packTomllink) throws PackTomlUrlException {
        try {
            ...
            var toml = new TomlParser().parse(connection.getInputStream());
