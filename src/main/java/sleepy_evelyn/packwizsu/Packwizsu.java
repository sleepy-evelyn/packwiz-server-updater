...
public class Packwizsu implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        if(packToml == null || packToml.isEmpty())
            LOGGER.info("Packwiz Updater loaded without a pack.toml file to update from");
        else
            LOGGER.info("Packwiz Updater loaded with pack.toml link: {}", configHandler.getValue("pack_toml"));
    }
